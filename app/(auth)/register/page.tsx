...
export default function RegisterPage() {
    ...
    const  handleSubmit = async (e: React.FormEvent) => {
        ...
        if(!strongPasswordRegex.test(password)) {
            setError("The password must be at least 8 characters long, and contain an uppercase letter, a lowercase letter, a number, and a special character (@$!%*?&#).");
            return;
        }
        ...
        try {
            ...
            if(!response.ok) {
                setError(data.error || "An error occurred during recording.");
                setIsLoading(false);
                return;
            }
            ...
            >
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-text-soft">
                        Join Mind Share today and start sharing your thoughts
                    </p>
                </div>
